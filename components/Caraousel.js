...
const contents = [
    {
        id: 1,
        image: "/female-doctor2_Testominial.jpg",
        name: "Kruthika",
        content:
    ...
    return (
        <div>
            <div className="mt-20 w-full flex justify-center items-center relative">
                ...
                >
                    <Image src="/arrowLeft.svg" alt="prev" width={40} height={40} />
                </button>
                            ...
                            <div className="flex justify-evenly gap-10 w-full">
                                ...
                                <div className="flex flex-col justify-start w-full">
                                    ...
                                    <div className="flex gap-3">
                                        {[...Array(5)].map((_, i) => (
                                            <Image key={i} src="/star.svg" alt="star" width={30} height={30} />
                                        ))}
                                    </div>
                ...
                >
                    <Image src="/arrowRight.svg" alt="prev" width={40} height={40} />
                </button>
            </div>
        </div>
    );
